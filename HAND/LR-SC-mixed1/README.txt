...
RUNNING ONE TEST
  Tests are .exe files, for instance LR-SC-mixed1.exe, run it by './LR-SC-mixed1.exe'
...
RUNNING OPTIONS
  ...
  For more options see for instance './LR-SC-mixed1.exe -help' and litmus documentation
