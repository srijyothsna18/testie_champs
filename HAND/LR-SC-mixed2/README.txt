Tests produced by litmus for architecture RISCV on linux 
...
RUNNING ONE TEST
  Tests are .exe files, for instance LR-SC-mixed2.exe, run it by './LR-SC-mixed2.exe'
...
RUNNING OPTIONS
  ...
  For more options see for instance './LR-SC-mixed2.exe -help' and litmus documentation
